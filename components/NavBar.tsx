    ...
    return (
        <nav className="hidden md:flex items-center justify-between px-4 py-2 bg-white border-b border-gray-200 shadow-sm font-sans sticky top-0 z-50">
            ...
            <div className="flex items-center gap-5">
                ...
                <button className="flex items-center gap-2 text-gray-600 hover:text-blue-600 text-[14px] pl-4 border-gray-200">
                ...
                <div
                    ...
                    <div className="flex items-center gap-2">
                        <span className="text-[13px] font-bold text-gray-700 uppercase whitespace-nowrap">ADMIN</span>
                    </div>
                </div>
            </div>
        </nav>
